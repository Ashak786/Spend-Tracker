...
interface UserProfileManagerProps {
  ...
  onAddUser: (name: string, salary: number) => void;
...
export default function UserProfileManager({
  ...
  React.useEffect(() => {
    ...
    setEditError(null);
  }, [currentUser.id, currentUser.name, currentUser.salary]);
  ...
  const handleCreate = (e: React.FormEvent) => {
    ...
    onAddUser(trimmedName, salaryNum);
    setNewName('');
    setNewSalary('');
    setAddError(null);
    setIsAdding(false);
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full text-sm pl-8 pr-4 py-2.5 border-2 border-slate-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 bg-white"
                />
              </div>
            </div>
          </div>
                  ...
                  <div className="space-y-2 w-full pr-8">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="text-xs px-6 py-1.5 border-2 border-slate-200 bg-white rounded-xl w-full focus:outline-none focus:ring-2 focus:ring-teal-500"
                      />
                    </div>
                    {editError && (
